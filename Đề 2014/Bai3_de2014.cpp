...
int main() {
    ...
    // tạo thông tin
    BasicContract* contract1 = new BasicContract("Nguyen", "2384616", "97 Man Thien", 100, 1000, 500, 200);
    DataFreeContract* contract2 = new DataFreeContract("DuyAn", "567895", "97 Man Thien", 200, 1000, 800, 200, 500);
    DataFixContract* contract3 = new DataFixContract("Duong", "43657", "97 Man Thien", 50, 1000, 180, 200, 1000000);
