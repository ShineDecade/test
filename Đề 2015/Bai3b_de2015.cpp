...
public:
    ...
    long tinhThueDoanhThu() override {
        return PHAN_TRAM_THUE_SAP_THUC_PHAM * this->_doanhThu;
    }
...
public:
    ...
    long tinhThueDoanhThu() override {
        return PHAN_TRAM_THUE_SAP_QUAN_AO * this->_doanhThu;
    }
...
int main() {
    ...
    quanLy.nhapThongTin();
    cout << "Tong so tien phai dong hang nam: " << quanLy.tinhTongTien() << " dong." << endl;
